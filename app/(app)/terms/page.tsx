  ...
  return (
    <div className="flex flex-col gap-y-2 items-center w-full p-6 policy">
      ...
      <p>
        ...
        conditions. Do not continue to use FT Quiz if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing FT Quiz, you agreed to use
        cookies in agreement with the FT {`QUIZ's`} Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, FT QUIZ and/or its licensors own the
        intellectual property rights for all material on FT Quiz. All
        intellectual property rights are reserved. You may access this from FT
        Quiz for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from FT Quiz</li>
        <li>Sell, rent or sub-license material from FT Quiz</li>
        <li>Reproduce, duplicate or copy material from FT Quiz</li>
        <li>Redistribute content from FT Quiz</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. FT
        QUIZ does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of FT QUIZ,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, FT QUIZ shall not be liable for the
      ...
      <p>
        FT QUIZ reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant FT QUIZ a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of FT QUIZ; and (d) the link is in
      ...
      <p>
        ...
        e-mail to FT QUIZ. Please include your name, your organization name,
      ...
      <p>
        No use of FT {`QUIZ's`} logo or other artwork will be allowed for
