      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to FT QUIZ.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to FT QUIZ, accessible from{" "}
            <a href="quiz.com" rel="external nofollow noopener" target="_blank">
              quiz.com
            </a>
          </p>
        </li>
